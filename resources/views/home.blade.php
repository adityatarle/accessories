...
<section class="relative gradient-bg text-white overflow-hidden">
    <div class="absolute inset-0 bg-cover bg-center bg-no-repeat" style="background-image: url('https://images.unsplash.com/photo-1586023492125-27b2c045efd7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2016&q=80');"></div>
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div class="text-center">
            ...
            <p class="text-xl md:text-2xl mb-10 text-pink-100 max-w-3xl mx-auto leading-relaxed">
            ...
            <div class="flex flex-col sm:flex-row gap-6 justify-center">
                <a href="{{ route('shop') }}" 
                   class="bg-white text-pink-600 px-10 py-4 rounded-full font-bold text-lg hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-lg">
                    🛍️ Shop Now
                </a>
                <a href="#featured" 
                   class="border-2 border-white text-white px-10 py-4 rounded-full font-bold text-lg hover:bg-white hover:text-pink-600 transition-all duration-300 transform hover:scale-105">
                    ✨ Explore Collection
                </a>
            </div>
        </div>
    ...
    <div class="absolute bottom-20 right-20 w-32 h-32 bg-yellow-300 opacity-20 rounded-full"></div>
    <div class="absolute top-1/2 right-10 w-16 h-16 bg-pink-300 opacity-30 rounded-full"></div>
</section>
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            ...
            <p class="text-xl text-gray-600 max-w-2xl mx-auto">Handpicked items that define style and elegance, carefully selected for you</p>
        </div>
...
<section class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <p class="text-gray-600">Fresh styles just added to our collection</p>
        </div>
...
<section class="py-20 gradient-bg relative overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 class="text-4xl md:text-5xl font-bold text-white mb-6">Stay in the Loop</h2>
        <p class="text-xl text-pink-100 mb-10 max-w-2xl mx-auto">Get the latest updates on new products, exclusive offers, and style tips delivered to your inbox</p>
